let pressDuration = 0; // 记录鼠标按的时长的变量 

// setup里的内容，在网页运转后一次性建立；
function setup() {
  createCanvas(windowWidth, windowHeight);
  background(0, 0, 255); // background只有放在setup才能显示鼠标留痕 
}
